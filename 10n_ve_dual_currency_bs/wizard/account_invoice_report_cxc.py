...
class AccountReportCXC(models.TransientModel):
    ...
    def action_invoices_report(self):
        ...
        if result:
            filename = '/tmp/cuentas_por_cobrar.xls'
            ...
            sheet.write_merge(0, 0, 3, 7, "CUENTAS POR COBRAR", title_style)
            ...
            for inv in result:
                ...
                sheet.write(i, 3, inv.get('ticket_fiscal') or inv.get('ticket_fiscal_pos') or inv.get('name'), cell_style)
