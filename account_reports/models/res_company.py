...
class ResCompany(models.Model):
    ...
    def _get_user_fiscal_lock_date(self):
        ...
        self.ensure_one()
        lock_date = max(self.period_lock_date or datetime.date.min, self.fiscalyear_lock_date or datetime.date.min)
        if self.user_has_groups('account.group_account_manager'):
            lock_date = self.fiscalyear_lock_date or datetime.date.min
        return lock_date