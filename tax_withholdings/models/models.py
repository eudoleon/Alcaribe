                        ...
                        if line.tax_ids:
                            for tax_id in line.tax_ids:
                                if tax_id.withholding_type == 'islr' and not line.tsc_cod_retencion_islr:
                                    raise exceptions.ValidationError("Por favor, indique el código de retencion de ISLR.")
...
class AccountMoveLineWithHoldings(models.Model):
    ...
    tsc_cod_retencion_islr = fields.Char(
        string="Cod. Ret. ISLR",
        store=True,)
            ...
            if line.tax_ids:
                ...
                if line.move_id:
                    for tax in line.tax_ids:
                        ...
                        if ('IVA' in tax.name or 'iva' in tax.name) and line.move_id.invoice_tax_id:
